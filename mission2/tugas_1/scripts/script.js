document.addEventListener("DOMContentLoaded", function () {
    class ShoppingCart {
      ...
      updateCart() {
        ...
        const totalAmountElement = document.querySelector(".nominal.total-bold");
    ...
    document.querySelector(".total").textContent = `Total Bayar: Rp. ${shoppingCart.total.toLocaleString(
      "id-ID"
    )}`;
  });
